        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          ...
          >
            ...
            <span className="text-xl font-bold tracking-tight">
              AWS ML <span className="text-aws-orange">Specialty</span>
            </span>
          </div>
        </div>
      </header>
          ...
          <div className="animate-in fade-in duration-500">
            <div className="text-center mb-12 mt-8">
              <h1 className="text-4xl md:text-5xl font-extrabold text-aws-navy mb-4">
                Master your AWS skills
              </h1>
              <p className="text-xl text-gray-600 max-w-2xl mx-auto">
                Realistic exam simulations and detailed practice modes designed
            ...
            <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
              ...
              >
                ...
                <div className="relative z-10">
                  ...
                  <h2 className="text-2xl font-bold text-gray-900 mb-3 group-hover:text-aws-blue transition-colors">
                    Practice Mode
                  </h2>
                  <p className="text-gray-600 mb-6 leading-relaxed">
                    Learn as you go. Get immediate feedback, detailed
                    explanations, and unlimited time per question. Perfect for
                    study sessions.
                  </p>
              ...
              >
                ...
                <div className="relative z-10">
                  ...
                  <h2 className="text-2xl font-bold text-gray-900 mb-3 group-hover:text-aws-orange transition-colors">
                    Exam Simulation
                  </h2>
                  <p className="text-gray-600 mb-6 leading-relaxed">
                    Simulate the real testing environment. Strict timer, no
                    immediate feedback, and a comprehensive review at the end.
                  </p>
                  <ul className="space-y-2 mb-8 text-sm text-gray-500">
                    <li className="flex items-center gap-2">
